...
|--------|------------------|---------------------|-------------|
| Transaction latency | 0.001ms | 33.8ms (remote 2PC over network) | [**30,000x faster**](docs/PERFORMANCE.md#verify-transaction-latency) |
...
<sub>All values measured. Remote 2PC uses real TCP coordination between 3 machines (Long Island, NY → AWS Virginia). Localhost benchmarks on same machine. [Full methodology →](docs/PERFORMANCE.md#benchmark-methodology)</sub>
