...
<sub>All values measured on the same machine. 2PC benchmark uses real TCP coordination between 3 OS processes. [Full methodology →](docs/PERFORMANCE.md#benchmark-methodology)</sub>
